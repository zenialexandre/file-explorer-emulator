...
fn end_paste_file_operation(mut selected_current_stack: String, file_name: String, copied_file_or_dir_name_joined: String, previous_operation_done: &Mutex<String>) {
...
fn paste_dir(selected_current_stack: String, copied_file_or_dir_name_joined: String, files: &UseRef<Files>, previous_operation_done: &Mutex<String>) {
...
fn paste_dir_with_conflict(mut selected_current_stack: String, copied_file_or_dir_name_joined: String, previous_operation_done: &Mutex<String>, copy_options: &CopyOptions) {
    *COPY_INCREMENTAL_ID.lock().unwrap() += 1;
