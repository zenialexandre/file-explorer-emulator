...
use dioxus::html::geometry::{Coordinates, PagePoint};
...
lazy_static! { static ref CONTEXT_MENU_ID: Mutex<Vec<WindowId>> = Mutex::new(Vec::new()); }
...
#[inline_props]
fn context_menu_popup(cx: Scope, files_props: UseRef<Files>) -> Element {
